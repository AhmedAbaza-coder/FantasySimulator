...
public class Player {
    ...
    public String toString() {
        return String.format("[Name: %s %s -  - Position: %s - Number: %d - Nationality: %s\n PLD: %s - Appearance: %d - CleanSheets: %d - Goals: %d - Assists: %d - Points: %d\n Price: %.2f - PicID: %s]",
                getFirstName(),getLastName(),getPosition(),getPlayerNumber(),getNationality(),getPld(),getAppearance(),getCleanSheet(),getGoals(),getAssists(),getPoints(),getPrice(),getPictureId());
    }
